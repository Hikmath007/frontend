...
const listingpage = () => {
  ...
  async function fetchData() {
    try {
      const response = await axios.get(
        "http://localhost:8080/creditdebit/api/v1/invoice"
      );
  ...
  const columns = [
    ...
    { field: "poNumber", headerName: "PO Number", flex: 1, minWidth: 200 },
    {
      field: "materialCode",
    ...
    { field: "oldRate", headerName: "Old Rate", flex: 1, minWidth: 200 },
    { field: "newRate", headerName: "New Rate", flex: 1, minWidth: 200 },
    { field: "difference", headerName: "Difference", flex: 1, minWidth: 200 },
    { field: "totalPrice", headerName: "Total Price", flex: 1, minWidth: 200 },
    {
      field: "status",
      headerName: "Status",
      flex: 1,
    ...
    {
      field: "supplementaryInvoiceNo",
      headerName: "Supplementary Invoice No",
      flex: 1,
    },
  ];
